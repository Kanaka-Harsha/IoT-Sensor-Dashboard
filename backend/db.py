...
def init_db():
    ...
    try:
        with conn.cursor() as cur:
            ...
            cur.execute("ALTER TABLE washroom_hygiene ADD COLUMN IF NOT EXISTS temperature_c REAL;")
            cur.execute("ALTER TABLE washroom_hygiene ADD COLUMN IF NOT EXISTS humidity REAL;")
